  ...
  singleSpace?.columns.map((column) => {
    if (column.field === "name") {
      ...
      return updatedColumns.push({
        ...
        renderCell: (params) => {
          const value = params.value;
          return <img src={"/assets/user.png"} className="w-[30px] h-[30px]" />;
        },
      });
        ...
        renderCell: (params) => {
          ...
          return (
            <span className={overDue ? `text-[#6870fa]` : `text-[red]`}>
              {value && timeago.format(new Date(value))}
            </span>
          );
        },
      });
        ...
        renderCell: (params) => {
          ...
          return (
            ...
            `}
              ...
              {openStatus && <StatusBar taskId={params.row._id} setOpenStatus={setOpenStatus} />}
            </div>
          );
        },
      });
